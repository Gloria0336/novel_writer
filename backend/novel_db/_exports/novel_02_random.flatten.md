...
characters:
  ...
  - id: fuldra
    ...
    species: 人妖混血（半人半龍）
    occupation: 北方要塞第三軍團統帥
    origin: 未公開
    base: 第一大陸，北方要塞
    appearance_public: >
      外貌停留在三十出頭，身形高挑，身高約一百八十公分，比例勻稱而無贅肉，
      是數百年不間斷實戰留下的體態。五官冷豔，面部線條銳利，靜止時如同完成的雕刻，
      幾乎沒有任何表情上的餘韻。銀白長髮，質地細而直，大多垂落肩後，戰時束起。
      頭頂一對黑色龍角，形態修長、微微向後彎，是她混血身分在外觀上最明顯的標記。
      其餘外觀特徵與人類幾乎相同，沒有鱗片或爪，但皮膚觸感略低於人類正常體溫，
      接觸時會讓對方短暫察覺某種說不上來的異質感。
    appearance_current: 尚未登場。
    personality:
      - 殺伐果斷，決策不留餘地，執行不待猶豫。
      - 對生死極度漠然，必要時能做出常人無法承受的決定。
      - 對下屬要求極高，要求的不是服從表演，而是能活下去的能力。
      - 不苟言笑，幾乎不在戰鬥與軍務以外的情境主動開口。
      - 將北方要塞視為自己用數百年守下來的領地，而非帝國授予的職位。
    speech_style:
      baseline: 簡短、冷靜、軍令式，不為安撫或社交多說一句。
      under_stress: 情緒不外露，語句更短，直接轉為命令。
      humor: 未出現。
    abilities:
      - 龍族血脈：半龍血統帶來遠超人類極限的體能、耐久與自我修復能力，在酷寒、高壓與長期戰鬥環境下衰退速度極低。
      - 戰場壓制：數百年實戰積累，無固定流派，每一個動作都追求最高效率；戰鬥風格偏向佔據空間、掌握節奏、壓垮對方反應。
      - 統帥能力：鎮守北方要塞數百年，獨立指揮過無數防禦戰與討伐任務，對北方地形、氣候與敵方行動模式的掌握超出現役帝國將領。
    current_status: >
      名義上隸屬帝國，擁有第三軍團統帥頭銜；實質上北方要塞是她的獨立領地。
      帝國中央知悉這條邊界，長年默認她不插手帝國政治、帝國也不干預北方事務。
      她對貝奧爾德的存在是否有所知悉，尚未公開。
    progressions:
      - at_chapter: world-bible
        status: 以北方要塞第三軍團統帥身分加入正式角色設定。
    goals:
      - 守住北方要塞。
    secrets:
  ...
  - id: butterfly-yao
    ...
    related_lore:
      ...
      - 多元聯邦 / 塞瑞涯（location.yaml 條目）：本角色所在地。
