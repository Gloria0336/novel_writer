...
/**
 * 矮人種族卡 D02 / D06–D08 / D10–D15
 * 設計主軸：爐火操作、裝備強化、氏族羈絆、礦山地形、麥酒/宴會。
 *
 * v3.4 重構：原 D01/D04/D05/D09（修復無人機/自動哨兵/魔導砲台/攻城巨砲）
 * 已下放為通用「魔導系列」器具卡 K01–K04（見 devices.ts），矮人不再壟斷器具池。
 * 原 D03 合金回收 → 通用法術 S17 拆解術。
 * 新增 D11 山王衛兵 / D12 鍛爐祝禱 / D13 氏族飲宴 / D14 深山礦坑 / D15 鋼鬚鍛師
...
export const DWARF_CARDS: Card[] = [
  ...
  // ---- v3.4 新增：純矮人文化向 ----
  {
    id: "D11", type: "troop", name: "山王衛兵", cost: 3, rarity: "uncommon",
    hp: 18, atk: 4, def: 6, keywords: ["guard"],
    passive: [{ kind: "scripted", tag: "MOUNTAIN_KING_GUARD" }],
    flavor: "他守的不是國王，是山。",
  },
  {
    id: "D12", type: "spell", name: "鍛爐祝禱", cost: 2, rarity: "common",
    effects: [
      { kind: "gauge", delta: 30, side: "self" },
  ...
  {
    id: "D13", type: "spell", name: "氏族飲宴", cost: 3, rarity: "uncommon",
    effects: [
  ...
  {
    id: "D14", type: "field", name: "深山礦坑", cost: 4, rarity: "uncommon",
    effects: [{ kind: "scripted", tag: "FIELD_DEEP_MINE" }],
    flavor: "他們挖了三百年，挖到一座宮殿，又挖出第二座。",
  },
  {
    id: "D15", type: "troop", name: "鋼鬚鍛師", cost: 4, rarity: "rare",
