...
export const DEMIGOD_CARDS: Card[] = [
  ...
  {
    id: "S_g_04", type: "spell", name: "神隱", cost: 1, rarity: "uncommon",
    effects: [{ kind: "scripted", tag: "G_DIVINE_HIDE" }],
  },
  {
    id: "A_g_03", type: "action", name: "神言：崩壞", cost: 4, rarity: "rare",
    effects: [{ kind: "scripted", tag: "G_DIVINE_WORD_COLLAPSE" }],
  },
  {
    id: "T_g_02", type: "troop", name: "不朽神使", cost: 5, rarity: "rare",
  ...
  {
    id: "A_g_04", type: "action", name: "創世殘章", cost: 8, rarity: "legendary",
