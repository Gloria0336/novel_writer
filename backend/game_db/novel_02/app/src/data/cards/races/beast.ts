...
export const BEAST_CARDS: Card[] = [
  {
    id: "S_b_01", type: "spell", name: "鮮血祭祀", cost: 1, rarity: "common",
    effects: [{ kind: "scripted", tag: "B_BLOOD_RITE" }],
  },
  {
    id: "T_b_01", type: "troop", name: "蠻牙戰士", cost: 2, rarity: "common",
    hp: 14, atk: 6, def: 1, keywords: [],
    passive: [{ kind: "scripted", tag: "B_SAVAGEFANG_BLOODRITE_X3" }],
  },
  {
    id: "S_b_02", type: "spell", name: "捕食者直覺", cost: 2, rarity: "common",
    effects: [
  ...
  {
    id: "T_b_02", type: "troop", name: "巨角衝鋒獸", cost: 4, rarity: "uncommon",
  ...
  {
    id: "A_b_01", type: "action", name: "狼群戰術", cost: 3, rarity: "uncommon",
    effects: [
  ...
  {
    id: "A_b_02", type: "action", name: "蠻力突進", cost: 2, rarity: "uncommon",
    effects: [{ kind: "scripted", tag: "B_BRUTE_CHARGE" }],
  },
  {
    id: "E_b_01", type: "equipment", name: "戰痕勳章", cost: 3, rarity: "uncommon",
    slot: "trinket", modifiers: {},
    passive: [{ kind: "scripted", tag: "B_BATTLE_SCAR_MEDAL" }],
  },
  {
    id: "S_b_03", type: "spell", name: "原始狂嚎", cost: 3, rarity: "rare",
    effects: [{ kind: "scripted", tag: "B_PRIMAL_HOWL" }],
  },
  {
    id: "T_b_03", type: "troop", name: "戰爭猛瑪象", cost: 6, rarity: "rare",
