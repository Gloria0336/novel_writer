...
const HUMAN: RaceFrame = {
  ...
  fullGaugeBuff: {
    ...
    name: "軍勢壓陣",
    description: "滿軍令時，己方所有兵力 ATK +1 / DEF +1。",
    rules: [{ kind: "troopAura", atk: 1, def: 1 }],
  },
...
const ELF: RaceFrame = {
  ...
  fullGaugeBuff: {
    ...
    name: "星脈盈流",
    description: "滿共鳴時，每個己方回合額外獲得 1 點臨時魔力。",
    rules: [{ kind: "turnStartTempMana", amount: 1 }],
  },
...
const DWARF: RaceFrame = {
  ...
  fullGaugeBuff: {
    ...
    name: "爐心過熱",
    description: "滿爐火時，裝備與器具費用 -1（最低 1），器具 DEF +2。",
    rules: [
      { kind: "cardCostReduction", cardTypes: ["equipment", "device"], amount: 1, minCost: 1 },
      { kind: "deviceAura", def: 2 },
    ],
  },
...
const FEY: RaceFrame = {
  ...
  fullGaugeBuff: {
    ...
    name: "盈月雙形",
    description: "滿靈蘊時，人形法術效果 +15%；妖形行動/攻擊傷害 +10%，英雄 DEF +3。",
    rules: [{ kind: "feyForm", humanSpellEffectPct: 15, feyActionDamagePct: 10, feyAttackDamagePct: 10, feyDef: 3 }],
  },
...
const BEAST: RaceFrame = {
  ...
  fullGaugeBuff: {
    ...
    name: "血月狂熱",
    description: "滿血怒時，英雄行動卡傷害 +20%，且擊殺兵力時恢復英雄 5 HP。",
    rules: [
      { kind: "actionDamagePct", pct: 20 },
      { kind: "healHeroOnKillTroop", amount: 5 },
    ],
  },
...
const DEMIGOD: RaceFrame = {
  ...
  fullGaugeBuff: {
    ...
    name: "神域殘光",
    description: "滿神力殘響時，英雄受到傷害 -20%。",
    rules: [{ kind: "heroDamageTakenPct", pct: -20 }],
  },
...
const DEMON: RaceFrame = {
  ...
  fullGaugeBuff: {
    ...
    name: "黑暗蝕滿溢",
    description: "滿黑暗蝕時，惡魔方兵力傷害 +10%，且每個己方回合開始時所有惡魔方兵力恢復 3 HP。",
    rules: [
      { kind: "troopDamagePct", pct: 10 },
      { kind: "turnStartTroopHeal", amount: 3 },
    ],
  },
