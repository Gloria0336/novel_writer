...
export const HERO_LIST: HeroDefinition[] = [HERO_LULU, HERO_MOUNTAIN_HUNTER, HERO_REKA, HERO_ELNO_HONORARY_MAGE, HERO_BUTTERFLY_YAO, HERO_ELDR_THORIN, HERO_AELLA_FLAIR];

export { HERO_LULU, HERO_MOUNTAIN_HUNTER, HERO_REKA, HERO_ELNO_HONORARY_MAGE, HERO_BUTTERFLY_YAO, HERO_ELDR_THORIN, HERO_AELLA_FLAIR };
